...
##### Edited for adaptation by YudiWidiyanto
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#
...
ZIP=Warrior-Kernel-$z-redmi2-$DATE.zip;

#dtb tool

./Warrior/dtbToolCM -2 -o ./arch/arm/boot/dt.img -s 2048 -p ./scripts/dtc/ ./arch/arm/boot/dts/
